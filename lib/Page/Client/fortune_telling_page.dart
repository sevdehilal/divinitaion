...
import 'package:divinitaion/Widgets/ClientWidgets/fortune_topics_dropdown.dart';
                        ...
                        onPressed: _isButtonDisabled
                            ...
                            : () async {
                                ...
                                if (selectedTopic1Index != null) {
                                  categoryIds.add(selectedTopic1Index!);
                                }
                                if (selectedTopic2Index != null) {
                                  categoryIds.add(selectedTopic2Index!);
                                }
                                ...
                                if (success) {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                      content: Text(
                                          'Fal gönderirken hata oluştu! Lütfen tekrar deneyiniz.')));
                                }
                              },
